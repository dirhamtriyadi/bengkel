...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_http_handler.accountInput"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_http_handler.loginInput"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_http_handler.refreshInput"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_http_handler.branchInput"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_http_handler.customerInput"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_http_handler.whatsAppSettingsInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/integrations/whatsapp/session/status": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_http_handler.stockInput"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_http_handler.journalInput"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_http_handler.productInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/public/invoices/{token}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Public invoice token",
                        "name": "token",
                        "in": "path",
                        "required": true
                    }
        ...
        "/public/invoices/{token}/midtrans/snap": {
            "post": {
        ...
        "/public/invoices/{token}/midtrans/sync": {
            "post": {
                "produces": [
                    "application/json"
                ],
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_http_handler.roleInput"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_http_handler.checkoutInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/sales/{id}/public-invoice/whatsapp": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_http_handler.userInput"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_http_handler.userUpdateInput"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_http_handler.vehicleInput"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_http_handler.workOrderInput"
                        }
                    }
                ],
                "responses": {
        ...
        "/work-orders/intake": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Penerimaan motor",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_http_handler.intakeInput"
                        }
                    }
                ],
                "responses": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_http_handler.workOrderUpdateInput"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_http_handler.workItemInput"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "bengkel_internal_http_response.APIError": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
                ...
                "details": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/bengkel_internal_http_response.FieldError"
                    }
                },
                "message": {
                    "type": "string"
        ...
        "bengkel_internal_http_response.Envelope": {
            "type": "object",
            "properties": {
                "data": {},
                "error": {
                    "$ref": "#/definitions/bengkel_internal_http_response.APIError"
                },
                "meta": {
                    "$ref": "#/definitions/bengkel_internal_http_response.Meta"
                }
            }
        },
        "bengkel_internal_http_response.FieldError": {
            "type": "object",
            "properties": {
                "field": {
                    "type": "string"
        ...
        "bengkel_internal_http_response.Meta": {
            "type": "object",
            "properties": {
                "last_page": {
                    "type": "integer"
        ...
        "internal_http_handler.accountInput": {
            "type": "object",
            "required": [
                "code",
                "is_active",
        ...
        "internal_http_handler.branchInput": {
            "type": "object",
            "required": [
                "code",
                "currency",
        ...
        "internal_http_handler.customerInput": {
            "type": "object",
            "required": [
                "code",
                "name"
        ...
        "internal_http_handler.intakeCustomerInput": {
            "type": "object",
            "required": [
                "name"
            ],
        ...
        "internal_http_handler.intakeInput": {
            "type": "object",
            "required": [
                "complaint"
            ],
            "properties": {
                ...
                "customer": {
                    "$ref": "#/definitions/internal_http_handler.intakeCustomerInput"
                },
                "customer_id": {
                    "type": "string"
                },
                ...
                "vehicle": {
                    "$ref": "#/definitions/internal_http_handler.intakeVehicleInput"
                },
                "vehicle_id": {
                    "type": "string"
                }
        ...
        "internal_http_handler.intakeVehicleInput": {
            "type": "object",
            "required": [
                "identifier"
            ],
        ...
        "internal_http_handler.journalInput": {
            "type": "object",
            "required": [
                "description",
                "entry_date",
            ...
            "properties": {
                ...
                "lines": {
                    ...
                    "minItems": 2,
                    "items": {
                        "$ref": "#/definitions/internal_http_handler.journalLineInput"
                    }
                }
            }
        },
        "internal_http_handler.journalLineInput": {
            "type": "object",
            "required": [
                "account_id"
            ],
        ...
        "internal_http_handler.loginInput": {
            "type": "object",
            "required": [
                "email",
                "password"
        ...
        "internal_http_handler.productInput": {
            "type": "object",
            "required": [
                "name",
                "sku",
        ...
        "internal_http_handler.refreshInput": {
            "type": "object",
            "required": [
                "refresh_token"
            ],
        ...
        "internal_http_handler.roleInput": {
            "type": "object",
            "required": [
                "code",
                "name",
        ...
        "internal_http_handler.stockInput": {
            "type": "object",
            "required": [
                "direction",
                "product_id",
        ...
        "internal_http_handler.userInput": {
            "type": "object",
            "required": [
                "email",
                "is_active",
        ...
        "internal_http_handler.userUpdateInput": {
            "type": "object",
            "required": [
                "email",
                "is_active",
        ...
        "internal_http_handler.vehicleInput": {
            "type": "object",
            "required": [
                "identifier"
            ],
        ...
        "internal_http_handler.whatsAppSettingsInput": {
            "type": "object",
            "properties": {
                "api_token": {
                    "type": "string",
        ...
        "internal_http_handler.workItemInput": {
            "type": "object",
            "required": [
                "product_id",
                "quantity"
        ...
        "internal_http_handler.workOrderInput": {
            "type": "object",
            "required": [
                "complaint",
                "customer_id",
        ...
        "internal_http_handler.workOrderUpdateInput": {
            "type": "object",
            "required": [
                "status"
            ],
